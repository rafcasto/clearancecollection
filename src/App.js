...
addToCart (item) {
  ...
  if (!found) { updatedCart.push({id: item.id,currency:item.currency, name: item.name,url:item.url, price: item.price, quantity: 1}) }
